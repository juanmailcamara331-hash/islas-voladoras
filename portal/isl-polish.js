(function(){
  ...
  style.textContent=`
    html,body{overflow-x:hidden!important;overflow-y:auto!important;min-height:100%!important;height:auto!important;overscroll-behavior-y:auto!important}
    .app,main,.view.active{min-height:0!important;overflow:visible!important}
    ...
    html:fullscreen,html:-webkit-full-screen,html:fullscreen body,html:-webkit-full-screen body{overflow-x:hidden!important;overflow-y:auto!important;height:auto!important;min-height:100%!important}
    ...
    /* Landscape phones/tablets: vertical dock on the RIGHT, independently scrollable. */
    @media(orientation:landscape) and (max-height:760px){
      html,body,.app,main,.view.active{overflow-y:auto!important;height:auto!important;min-height:0!important;touch-action:pan-y!important;-webkit-overflow-scrolling:touch!important}
      body{padding-bottom:0!important;padding-right:max(64px,calc(env(safe-area-inset-right) + 58px))!important}
      main{width:auto!important;max-width:none!important;margin:0!important;padding-top:10px!important;padding-right:12px!important;padding-bottom:34px!important;padding-left:max(12px,env(safe-area-inset-left))!important;overflow:visible!important}
      .rail{position:fixed!important;top:max(8px,env(safe-area-inset-top))!important;right:max(6px,env(safe-area-inset-right))!important;bottom:max(8px,env(safe-area-inset-bottom))!important;left:auto!important;width:54px!important;max-width:54px!important;height:auto!important;min-height:0!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:flex-start!important;gap:5px!important;padding:7px 5px!important;overflow-x:hidden!important;overflow-y:auto!important;overscroll-behavior-y:contain!important;-webkit-overflow-scrolling:touch!important;border:1px solid #294955!important;border-radius:18px!important;background:#071018ef!important;box-shadow:0 16px 40px #0008!important;scrollbar-width:none!important;z-index:14000!important}
      .rail::-webkit-scrollbar{display:none!important}
      .logo{flex:0 0 auto!important;writing-mode:horizontal-tb!important;transform:none!important;margin:0 0 2px!important;font-size:9px!important}
      .rail button{flex:0 0 40px!important;min-width:40px!important;width:40px!important;height:40px!important;border-radius:12px!important;font-size:16px!important}
      .drawer{left:auto!important;right:max(64px,calc(env(safe-area-inset-right) + 58px))!important;top:max(8px,env(safe-area-inset-top))!important;bottom:max(8px,env(safe-area-inset-bottom))!important;width:min(340px,62vw)!important;max-height:none!important;overflow-y:auto!important;transform:translateX(calc(100% + 420px))!important}
      .drawer.open{transform:translateX(0)!important}
      #islFsToggle{right:max(70px,calc(env(safe-area-inset-right) + 64px))!important;bottom:max(12px,env(safe-area-inset-bottom))!important;top:auto!important}
      html:fullscreen #islFsToggle,html:-webkit-full-screen #islFsToggle{right:max(70px,calc(env(safe-area-inset-right) + 64px))!important;top:max(12px,env(safe-area-inset-top))!important;bottom:auto!important}
      .hero{min-height:0!important;height:auto!important}.heroText{min-height:0!important}
      #welcome{padding:8px max(74px,calc(env(safe-area-inset-right) + 66px)) 10px max(12px,env(safe-area-inset-left))!important;overflow-y:auto!important;align-items:flex-start!important}
      .welcome-inner{width:min(1000px,94vw)!important;margin:auto!important;padding:4px 0!important}
      .isl-logo{width:96px!important;height:96px!important;margin:0 auto 6px!important}
      .isl-logo .ring{inset:8px!important}.isl-logo .ring.r2{inset:19px!important}.isl-logo .core{inset:27px!important}.isl-logo .core b{font-size:21px!important}
      .welcome-kicker{font-size:9px!important;letter-spacing:.16em!important}
      .welcome-title{font-size:clamp(30px,5.5vw,54px)!important;line-height:.94!important;margin:5px 0 7px!important}
      .welcome-quote{font-size:clamp(15px,2.3vw,22px)!important;line-height:1.14!important;margin:7px auto 10px!important}
      #welcome .actions{margin-top:7px!important;gap:6px!important;display:flex!important;flex-wrap:wrap!important;justify-content:center!important}
      #welcome .actions .btn{padding:7px 10px!important;font-size:11px!important;min-height:34px!important}
    }

    @media(prefers-reduced-motion:reduce){button,.btn,a[role=button],.rail button{transition:none!important}.isl-pressed{filter:none!important;box-shadow:none!important}#islTopBreath{animation:none!important;opacity:.28!important}}
  `;
  ...
  var track=document.getElementById('track'),audio=track&&track.querySelector('audio'),musicBtn=document.getElementById('musicBtn'),userMuted=false;
  ...
  var fsButton=document.createElement('button');fsButton.id='islFsToggle';fsButton.type='button';document.body.appendChild(fsButton);
