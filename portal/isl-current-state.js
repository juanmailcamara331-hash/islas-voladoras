  ...
  ready(function(){
    ...
    function renderPolls(p){
      ...
      view.innerHTML=
        ...
        '<div class="panel" style="margin-top:12px;border-color:#58706f;background:linear-gradient(135deg,#101d1c,#0d171a)"><div class="label">VALIDACIÓN DIALÉCTICA · LITE v2</div><h2 style="margin:4px 0 7px">PILARES</h2><div class="sub">Ronda corta para medir comprensión, tirón, vibra y preocupaciones sin fatigar a la gente.</div><div class="pollActions"><a class="btn primary" target="_blank" rel="noopener" href="https://islas-voladoras-isl.netlify.app/poll/pilares-lite-v2.html">ABRIR PILARES LITE v2</a></div></div><div class="panel" style="margin-top:12px;border-color:#6e5f85;background:linear-gradient(135deg,#171526,#101820)"><div class="label">FRIENDS_SAMPLE · LITE v2</div><h2 style="margin:4px 0 7px">REFERENCIAS</h2><div class="sub">Extrae funciones útiles sin votar qué personaje copiar. La decisión final sigue siendo humana.</div><div class="pollActions"><a class="btn primary" target="_blank" rel="noopener" href="https://islas-voladoras-isl.netlify.app/poll/referencias-lite-v2.html">ABRIR REFERENCIAS LITE v2</a><a class="btn" href="survey-results.html">RESULTADOS</a></div></div>';
    ...
    (function installFriendsTestBlock(){
      ...
      box.innerHTML='<div class="eyebrow" style="color:#ffd27a">🚨 PRUEBA CON COLEGAS · TEMPORAL</div>'+
        ...
        '<div class="sub" style="margin-bottom:12px">Hoy: dos encuestas cortas. Primero Pilares Lite v2, después Referencias Lite v2. Luego miramos resultados sin decidir por mayoría.</div>'+
        '<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:9px">'+
          '<a class="btn primary" style="padding:14px;text-align:center;font-weight:900" href="https://islas-voladoras-isl.netlify.app/poll/pilares-lite-v2.html" target="_blank" rel="noopener">1 · PILARES LITE v2</a>'+
          '<a class="btn" style="padding:14px;text-align:center;font-weight:900" href="https://islas-voladoras-isl.netlify.app/poll/referencias-lite-v2.html" target="_blank" rel="noopener">2 · REFERENCIAS LITE v2</a>'+
          '<a class="btn" style="padding:14px;text-align:center;font-weight:900" href="survey-results.html">3 · VER RESULTADOS</a>'+
          '<a class="btn" style="padding:14px;text-align:center;font-weight:900" href="salon-cortinas-rojas.html">EXTRA · SALÓN ROJO</a>'+
        '</div>'+
