    ...
    (function installFriendsTestBlock(){
      ...
      box.innerHTML='<div class="eyebrow" style="color:#ffd27a">🚨 PRUEBA CON COLEGAS · TEMPORAL</div>'+
        ...
        '<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:9px">'+
          '<a class="btn primary" style="padding:14px;text-align:center;font-weight:900" href="https://islas-voladoras-isl.netlify.app/poll/pilares-argumento.html" target="_blank" rel="noopener">1 · PILARES Y ARGUMENTO</a>'+
          ...
          '<a class="btn" style="padding:14px;text-align:center;font-weight:900" href="https://islas-voladoras-isl.netlify.app/poll/referencias-amigos.html" target="_blank" rel="noopener">4 · REFERENCIAS</a>'+
        '</div>'+
