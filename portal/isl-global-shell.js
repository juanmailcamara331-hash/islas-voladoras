...
items.forEach(function(it){
  ...
  var active=(path==='mission-map.html'&&it[0]==='Misión')||
    (path==='project-observatory.html'&&it[0]==='Observatorio')||
