...
var items=[
 ...
 ['Playtest',href('playtest-lab.html'),'','Playtest Lab']
];
...
var panel=document.createElement('div');panel.id='islGlobalMore';panel.innerHTML='<a href="'+href('playtest-lab.html')+'">Playtest Lab · juega y deja huella</a><a href="https://islas-voladoras-isl.netlify.app/playtest-results">Playtest Evidence · agregado</a><a href="'+href('playtest-review.html')+'">Playtest Review · decisión humana</a><a href="'+href('signal-telegraph-lab.html')+'">Signal / Telegraph Lab v0.1</a><a href="'+href('external-lab.html')+'">External Lab · Gemini/MJ</a><a href="'+href('spielberg-lab.html')+'">Spielberg Lab Feed · I+D externa</a><a href="'+href('knowledge-health.html')+'">Knowledge Health · grafo</a><a href="'+href('encuestas.html')+'">Encuestas / resultados</a><a href="'+href('capsulas-tv.html')+'">Cápsulas TV</a><a href="'+href('ps4.html')+'">PS4</a><a href="'+href('musica.html')+'">Música</a><a href="'+href('salon-cortinas-rojas.html')+'">Salón Rojo</a><a href="'+href('isla-baile-inagotable.html')+'">Isla Baile</a><a href="'+href('index.html?full=1','#home')+'">Centro técnico</a>';document.body.appendChild(panel);
