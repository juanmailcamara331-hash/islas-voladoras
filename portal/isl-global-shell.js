...
var items=[
 ...
 ['Encuestas',href('survey-results.html'),'','Encuestas y resultados'],
...
items.forEach(function(it){var a=document.createElement('a');a.href=it[1];a.className=it[2]||'';a.textContent=it[0];a.title=it[3];if((path==='index.html'&&it[0]==='Centro')||(path==='rpg-home.html'&&it[0]==='Perfil')||(path==='encuestas.html'&&it[0]==='Encuestas')||(path==='huellas.html'&&it[0]==='Brújula')||(path==='capsulas.html'&&it[0]==='Cápsulas')||(path==='survey-results.html'&&it[0]==='Encuestas')||(path==='recreo.html'&&it[0]==='Recreo'))a.classList.add('active');row.appendChild(a)});
...
var panel=document.createElement('div');panel.id='islGlobalMore';panel.innerHTML='<a href="'+href('encuestas.html')+'">Encuestas / resultados</a><a href="'+href('capsulas-tv.html')+'">Cápsulas TV</a><a href="'+href('ps4.html')+'">PS4</a><a href="'+href('musica.html')+'">Música</a><a href="'+href('salon-cortinas-rojas.html')+'">Salón Rojo</a><a href="'+href('isla-baile-inagotable.html')+'">Isla Baile</a><a href="'+href('command-center.html?full=1','#home')+'">Centro técnico</a>';document.body.appendChild(panel);
