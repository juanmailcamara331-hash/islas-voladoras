...
items.forEach(function(it){var a=document.createElement('a');a.href=it[1];a.className=it[2]||'';a.textContent=it[0];a.title=it[3];if((path==='index.html'&&it[0]==='Centro')||(path==='rpg-home.html'&&it[0]==='Perfil')||(path==='encuestas.html'&&it[0]==='Encuestas')||(path==='huellas.html'&&it[0]==='Brújula')||(path==='capsulas.html'&&it[0]==='Cápsulas')||(path==='recreo.html'&&it[0]==='Recreo'))a.classList.add('active');row.appendChild(a)});
